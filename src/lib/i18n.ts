...
export const translations = {
  en: {
    ...
    teams_list: 'Participating Teams',
    ...
    match_save_error: 'Failed to save match',
    select_different_teams: 'A team cannot play against itself!',
    select_both_teams: 'Please select both teams',
    delete: 'Delete',
    select_team: 'Select team...',
    stream_url: 'Stream URL (Twitch/YouTube)',
    enter_stream_url: 'https://twitch.tv/...',
    map_list: 'Maps Played',
  ...
  ru: {
    ...
    sponsors: 'Спонсоры',
    select_sponsors: 'Выберите спонсоров',
    teams_list: 'Команды-участницы',
    ...
    match_save_error: 'Не удалось сохранить матч',
    select_different_teams: 'Команда не может играть сама с собой!',
    select_both_teams: 'Пожалуйста, выберите обе команды',
    delete: 'Удалить',
    select_team: 'Выберите команду...',
    stream_url: 'Ссылка на трансляцию',
    enter_stream_url: 'https://twitch.tv/...',
    map_list: 'Сыгранные карты',
    player_profile: 'Профиль игрока',
    kd_ratio: 'Убийства/Смерти',
  },
};