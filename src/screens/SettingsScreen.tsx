      ...
      <ScrollView className="flex-1 p-4" style={{ backgroundColor: theme === 'dark' ? '#111827' : '#f9fafb' }}>
        <View className="space-y-6">
          ...
          <View>
            ...
            <View className="rounded-xl overflow-hidden shadow-sm border" style={{
              ...
              >
                <View className="flex-row items-center">
                  {theme === 'dark' ? (
                      <Moon size={20} color="#6366f1" style={{ marginRight: 12 }} />
                  ) : (
                      <Sun size={20} color="#f97316" style={{ marginRight: 12 }} />
                  )}
                ...
                <View className={clsx(
                    "w-11 h-6 rounded-full justify-center",
                    theme === 'dark' ? "bg-indigo-600" : "bg-gray-200"
                )}>
                  <View className={clsx(
                      "bg-white h-5 w-5 rounded-full shadow-sm",
                      theme === 'dark' ? "self-end mr-0.5" : "self-start ml-0.5"
                  )} />
                </View>
              </TouchableOpacity>
            </View>
          ...
          <View>
            ...
            <View className="rounded-xl overflow-hidden shadow-sm border" style={{
              ...
              <TouchableOpacity
                  ...
                  className="w-full flex-row items-center justify-between p-4 border-b"
